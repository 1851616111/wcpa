...
func TestCreateMenu(t *testing.T) {
	...
	bt2.AddSub(NewMediaButton("我要报名", "XE0SukUeRkIhGbxSQMOVWzJHBdENl7NbvZFm_2o6fWY"))
	...
	bt3.AddSub(NewMediaButton("订单开课", "XE0SukUeRkIhGbxSQMOVWzJHBdENl7NbvZFm_2o6fWY"))
	bt3.AddSub(NewMediaButton("联系客服", "XE0SukUeRkIhGbxSQMOVWyDjnQ4_j5XXE5pH30UceoY"))
	bt3.AddSub(NewMediaButton("关于大嘴妞", "XE0SukUeRkIhGbxSQMOVWyGYHmERIaKLu69Xhqj4W9A"))
